...
<body>
<header class="header-area overlay position-fixed" style="top: 0 ; right: 0 ; width:100%; z-index:999;">
    <nav class="navbar navbar-expand-lg bg-light" style="height: 8vh ; width:100%;">
        <div class="container-fluid" style="width:100%">
            ...
            <ul class="navbar-nav">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    <li><a class="dropdown-item fw-semibold" href="<?= URL ?>produit.php">Toutes les catégories </a></li>
